...
public class PuzzleRotatePicFirst : MonoBehaviour
{
    ...
    [SerializeField] ItemData requiredItems;
    [SerializeField] int requiredCounts;
    [Header("Reward Item")]
    ...
    public bool firstIsOpen = false;

    public static PuzzleRotatePicFirst Instance { get; private set; }
